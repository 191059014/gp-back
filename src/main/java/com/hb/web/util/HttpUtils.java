 ...
 *
 * @author Mr.huang
 * @version com.hb.web.util.HttpUtils.java, v1.0
...
public class HttpUtils {
    ...
    public static String post(String url, Map<String, String> params, String encoding) {
        ...
        try {
            ...
            logger.error("HttpException", LogUtils.getStackTrace(e));
        } catch (IOException e) {
            logger.error("IOException", LogUtils.getStackTrace(e));
        } finally {
            if (postMethod != null) {
        ...
        for (Iterator<String> it = keys.iterator(); it.hasNext(); ) {
            ...
            if (map.containsKey(key)) {
                ...
                try {
                    ...
                    logger.error("unsupported encode: {}", LogUtils.getStackTrace(e));
                }
