...
public class AppJson implements Serializable {
    ...
    // 银行卡对公账号信息
    private PublicBankAccount publicBankAccount;
    ...
    public PublicBankAccount getPublicBankAccount() {
        return publicBankAccount;
    }

    public void setPublicBankAccount(PublicBankAccount publicBankAccount) {
        this.publicBankAccount = publicBankAccount;
    }
    ...
    public String toString() {
        return "AppJson{" +
                ...
                ", publicBankAccount=" + publicBankAccount +
                '}';
    }
}
